...
The AI Software Template that was executed comes with a sample application. This application will be built from https://github.com/redhat-appstudio-mjf/chatbot-rd-oct7-rm2-1, stored in [quay.io/maysunfaisal/chatbot-rd-oct7-rm2-1](https://quay.io/maysunfaisal/chatbot-rd-oct7-rm2-1) and deployed through ArgoCD. 
